...
public class Employee {
	...
	/*
	 * if we are achieving DI using setters then use <property tag in literals file
	 */
	...
	public void print() {
		System.out.println(
				"emp ID:" + empid + " Emp Name: " + empname + " Emp Address: " + address + " Salary: " + salary);
